...
\NormalTok{gdp_data }\OperatorTok{%<>%}\StringTok{  }\KeywordTok{transform}\NormalTok{(}\DataTypeTok{yr_qtr =} \KeywordTok{paste}\NormalTok{(Year, Qtr, }\DataTypeTok{sep=}\StringTok{"."}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{## I dropped }
\NormalTok{covariates <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"yr_qtr"}\NormalTok{, }\StringTok{"Realgdp"}\NormalTok{, }\StringTok{"Realcons"}\NormalTok{, }\StringTok{"Realinvs"}\NormalTok{, }\StringTok{"Realgovt"}\NormalTok{, }\StringTok{"Realdpi"}\NormalTok{, }\StringTok{"CPI_U"}\NormalTok{, }\StringTok{"M1"}\NormalTok{, }\StringTok{"Tbilrate"}\NormalTok{, }\StringTok{"Unemp"}\NormalTok{, }\StringTok{"Pop"}\NormalTok{, }\StringTok{"Infl"}\NormalTok{, }\StringTok{"Realint"}\NormalTok{)}
...
\midrule
\endhead
0.3367482 & 0.5617123\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
0.3367783 & 0.5616948\tabularnewline
\bottomrule
\end{longtable}
...
\NormalTok{rhs_vars <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Year"}\NormalTok{, }\StringTok{"Realgdp"}\NormalTok{, }\StringTok{"Realcons"}\NormalTok{, }\StringTok{"Realinvs"}\NormalTok{, }\StringTok{"Realgovt"}\NormalTok{, }\StringTok{"Realdpi"}\NormalTok{, }\StringTok{"CPI_U"}\NormalTok{, }\StringTok{"M1"}\NormalTok{, }\StringTok{"Tbilrate"}\NormalTok{, }\StringTok{"Unemp"}\NormalTok{, }\StringTok{"Pop"}\NormalTok{, }\StringTok{"Infl"}\NormalTok{, }\StringTok{"Realint"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(gdp_data}\OperatorTok{$}\NormalTok{Year, newres)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(gdp_data}\OperatorTok{$}\NormalTok{Year, newres2)}
\end{Highlighting}
\end{Shaded}
